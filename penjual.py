...
# Fungsi untuk membaca menu dari file CSV
...
# Fungsi untuk menyimpan menu ke file CSV
...
# Fungsi untuk membaca daftar orderan dari file CSV
...
# Fungsi untuk menyimpan daftar orderan ke file CSV
...
# Fungsi untuk membaca orderan yang sudah selesai (laporan penjualan)
            ...
            if nama_menu in menu:
                ...
                if ubah == 'y':
                    ...
                    try:
                        ...
                        menu[nama_baru] = harga_baru  # Mengubah nama dan harga menu sekaligus
